...
\begin{figure}[H]
    ...
    {
        Validation losses during training with and without \methodOne{1} applied on VQ-VAE Configuration 3. The results of \methodOne{1} in the plot shown for the non-conditioned decoder - $Decoder_1$, and Exact Sampling is used with SoftAdapt.
