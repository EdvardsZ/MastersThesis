...
\begin{figure}[H]
    ...
    {
        Validation losses during training with and without \method{1} applied on Gaussian VAE.
...
\begin{figure}[H]
    ...
    {
        Validation losses during training with and without \method{1} applied on VQ-VAE.
...
\begin{figure}[H]
    ...
    \caption[Validation loss during training with \method{2} applied on Gaussian VAE.]
    {
        Validation losses during training with and without \method{2} applied on Gaussian VAE.
...
\begin{figure}[H]
    ...
    {
        Validation losses during training with and without \method{2} applied on VQ-VAE.
