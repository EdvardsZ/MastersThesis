...
\draw    (467,103.25) .. controls (505.15,127.82) and (521.04,191.29) .. (521.96,213.55) ;
\draw [shift={(522,215.5)}, rotate = 270] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
...
\draw    (55,214.5) .. controls (59.67,128.5) and (113.33,108.57) .. (138,103.5) .. controls (162.67,98.43) and (421.33,63.92) .. (464,101.25) ;
...
\draw    (554.5,163.4) -- (575.69,211.42) ;
\draw [shift={(576.5,213.25)}, rotate = 246.19] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da6695013287922554] 
\draw    (554.33,227.2) -- (564.5,227.24) ;
\draw [shift={(566.5,227.25)}, rotate = 180.24] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
...
\draw    (464,101.25) .. controls (492.09,123.46) and (516.99,123.19) .. (521.73,148.89) ;
\draw [shift={(522,150.5)}, rotate = 261.67] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
...
\draw    (546,263.5) -- (570.57,239.64) ;
\draw [shift={(572,238.25)}, rotate = 135.84] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
...
% Text Node
\draw  [fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=0.49 ]  (581.03, 226.5) circle [x radius= 13.6, y radius= 13.6]   ;
\draw (575.03,218.9) node [anchor=north west][inner sep=0.75pt]    {$L$};
% Text Node
